...
-- follows the Spring 2026 format (shifted to the new hours).
...
cross join (values
  ...
  ('2026-10-25 12:30:00-04', '2026-10-25 13:00:00-04',
   ...
   'Take a break, recharge, and connect with other teams.',
   null, 30),
  ...
  ('2026-10-25 15:30:00-04', '2026-10-25 16:30:00-04',
   'Pitch Presentations',
   ...
   'Your pitch should cover the problem you identified, who it affects, a walkthrough of your solution, the tech you used, and your vision for where it goes next. Transitions between teams are kept to 2 minutes, so be ready before your slot.', 50),
  ('2026-10-25 16:30:00-04', '2026-10-25 17:30:00-04',
   ...
   'Winners announced live. Stick around for the closing ceremony.', 60)
